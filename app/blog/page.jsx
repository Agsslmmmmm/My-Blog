...
const page = () => {
    return (
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14 pt-24">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">My Blog</h2>
                <p class="mt-1 text-gray-600 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo quaerat veritatis laboriosam provident natus assumenda voluptatibus omnis soluta! Odit, vero.</p>
            </div>

            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <a class="group hover:bg-gray-100 shadow-2xl rounded-3xl border-gray-400 p-5 transition-all dark:hover:bg-white/[.05]" href="#">
